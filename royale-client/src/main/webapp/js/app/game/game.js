...
Game.prototype.doInput = function(imp) {
  ...
  for(var panel of this.panel.panels) {
    if(panel instanceof EmotePanel) {
      if(document.getElementById("settings").style.display !== "none" || document.getElementById("controls").style.display !== "none" || document.activeElement == document.getElementById("chat-input")) { return; }
